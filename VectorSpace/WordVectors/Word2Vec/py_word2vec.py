...
# from: https://github.com/klb3713/word2vec/tree/master/python
...
from numpy import empty, exp, dot, outer, random, dtype, get_include,\
...
# Example: ./py_word2vec.py ../data/text8 ../c/questions-words.txt ../data/text8
