...
processor = ResultsProcessor(dbname="metrics_codes_tmp")
...
def cross_validation(use_pretrained_embedding, bi_directional, num_rnns, merge_mode, hidden_size):
    ...
    SUFFIX = "_RNN_MOST_COMMON_TAG_HYPER_PARAM_TUNING_"
    CB_TAGGING_TD, CB_TAGGING_VD = "RE_RUN_CB_TAGGING_TD" + SUFFIX, "RE_RUN_CB_TAGGING_VD" + SUFFIX
