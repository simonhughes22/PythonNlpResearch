...
class Codes_ClassifyUsingQDA_WithBinaryValues(GwExperimentBase):
...
if __name__ == "__main__":
    ...
    cl = Codes_ClassifyUsingQDA_WithBinaryValues()
    (mean_metrics, wt_mean_metrics) = cl.Run("Codes_ClassifyUsingQDA_WithBinaryValues_WithTfIdfValues.txt")
