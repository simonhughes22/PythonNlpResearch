...
class Codes_ClassifyUsingSkLearnMaxEnt_WithBinaryValues(GwExperimentBase):
...
if __name__ == "__main__":
    ...
    for c in range(3,4,1):
        ...
        cl = Codes_ClassifyUsingSkLearnMaxEnt_WithBinaryValues(float(c), adjust_class_weight)
        (mean_metrics, wt_mean_metrics) = cl.Run("Codes_ClassifyUsingSkLearnMaxEnt_WithBinaryValues_C" + str(c) + s_cls_wt + ".txt", min_word_count = 2)
