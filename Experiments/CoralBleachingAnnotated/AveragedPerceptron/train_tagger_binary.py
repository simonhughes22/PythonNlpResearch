...
from perceptron_tagger_binary import PerceptronTagger
...
for i,(essays_TD, essays_VD) in enumerate(folds):
    ...
    for tag in wd_train_tags:
        ...
        td_metrics = toDict(processor.__get_metrics__(wd_td_ys_bytag, td_wd_predictions_by_code)[tag])
        vd_metrics = toDict(processor.__get_metrics__(wd_vd_ys_bytag, vd_wd_predictions_by_code)[tag])
