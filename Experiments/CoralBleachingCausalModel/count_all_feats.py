...
COLLECTION_PREFIX = "CR_CB_SHIFT_REDUCE_PARSER_TEMPLATED_FEATURE_SEL_COUNT_FEATS"
...
for ngrams in [1]:
    ...
    for stemmed in [True]:
        ...
        for cost_function_name in [micro_f1_cost_plusepsilon.__name__]:
            ...
            new_extractor_list = current_extractor_names + gbl_extractor_fn_names # type : List[str]
