...
def model_train_predict(essays_TD, essays_VD, extractor_names, cost_function_name, ngrams, stemmed, beta, max_epochs):
    ...
    parse_model = SearnModelEssayParserBreadthFirst(
    ...
    parse_model.train(essays_TD[:50], 1)

    for e in essays_VD:
        parses = parse_model.generate_all_potential_parses_for_essay(e, top_n=10)
        hhhh = 0
...
COLLECTION_PREFIX = "TEST_CR_CB_SHIFT_REDUCE_PARSER_TEMPLATED_HYPER_PARAM2"
