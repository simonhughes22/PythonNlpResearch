...
if __name__ == "__main__":
    ...
    vector_space = ("Lsa", lambda tokenized_docs : LatentWordVectors.LatentWordVectors.LsaSpace(tokenized_docs, topics, aggregation_method = "sentence", normalize = normalize))
    ...
    for parm_val in range(2, 3): #Best C val is 2
        ...
        (mean_metrics, wt_mean_metrics) = cl.Run("Codes_ClassifyUsingVectorComposition_WithSubSampling_VectorSpace_" + vector_space[0] + "_Dims" + str(topics) + "_" + algo + "_" + str(func.func_name) + s_idf + all_params + s_norm + '_NoThreshold.txt', stem = stem)
