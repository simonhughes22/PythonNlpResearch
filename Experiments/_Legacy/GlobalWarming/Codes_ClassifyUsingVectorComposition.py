...
class Codes_ClassifyUsingVectorComposition(GwExperimentBase):
...
if __name__ == "__main__":
    ...
    for parm_val in range(2, 3): #Best C val is 2
        ...
        cl = Codes_ClassifyUsingVectorComposition(topics, func, vector_space[1], algo, (parm_val), use_idf)
        (mean_metrics, wt_mean_metrics) = cl.Run("Codes_ClassifyUsingVectorComposition_VectorSpace_" + vector_space[0] + "_Dims" + str(topics) + "_" + algo + "_" + str(func.func_name) + s_idf + s_params + s_norm + '.txt', stem = stem)
